...
describe("HTLC", () => {
  ...
  //   const tx3 = await program.methods.redeem(COMMITIDArray, SECRETArray, pda.htlcBump).
  //     accountsPartial({
  ...
  //   // await wait(15000);
  //   // const tx4 = await program.methods.unlock(COMMITIDArray, pda.htlcBump).
  //   //   accountsPartial({
  //   //     userSigning: wallet.publicKey,
  //   //     htlc: pda.htlc,
  //   //     htlcTokenAccount: pda.htlcTokenAccount,
  ...
  //     bob.publicKey
  //   )
  //   const tx2 = await program.methods.redeem(IDArray, SECRETArray, pda.htlcBump).
  //     accountsPartial({
  //       userSigning: wallet.publicKey,
  //       htlc: pda.htlc,
  //       htlcTokenAccount: pda.htlcTokenAccount,
  ...
  it("Refund tokens after the timelock is expired", async () => {
    ...
    const tx2 = await program.methods.unlock(IDArray, pda.htlcBump).
      accountsPartial({
        userSigning: wallet.publicKey,
        htlc: pda.htlc,
        htlcTokenAccount: pda.htlcTokenAccount,
